...
namespace EnhancedHierarchy {
    internal static class ReflectionHelper {
        ...
        static ReflectionHelper() {
            ...
            imageConversionAssembly = engineAssembly;
            ...
            imageConversionType = imageConversionAssembly.GetType("UnityEngine.ImageConversion", false);
            ...
            if(imageConversionType == null && textureLoadMethod == null)
                foreach(var assembly in AppDomain.CurrentDomain.GetAssemblies()) {
                    imageConversionType = assembly.GetType("UnityEngine.ImageConversion", false);
            ...
            if(textureLoadMethod == null)
                Debug.LogError("Could not find LoadImage(byte[]) method");
        ...
        private static readonly Assembly imageConversionAssembly;
