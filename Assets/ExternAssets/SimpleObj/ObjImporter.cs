...
{
    //public static GameObject Import(string pathToOBJ)
    //{
    //    string mtlLibKeyword = "mtllib";

    //    string objString = File.ReadAllText(pathToOBJ);

    //    StringReader reader = new StringReader(objString);
    ...
    //    return Import(objString, mtlString, new Texture2D[0]);
    //}
    ...
    private static List<Hashtable> ImportGeometry(string objString, bool gameObjectPerGroup, bool subMeshPerGroup)
    {
        ...
        for (int i = 0; i < objString.Length; i++)
        {
            ...
            else if (beginOfLine && c == 'o' && i < objString.Length - 2 && objString[i + 1] == ' ')
            {  // object info follows
            ...
            else if (beginOfLine && c == 'g' && i < objString.Length - 2 && objString[i + 1] == ' ')
            {  // group info follows
                int e = objString.IndexOfEndOfLine(i + 2);
                if (e > i + 2)
                {
            ...
            else if (beginOfLine && c == 'u' && i < objString.Length - 7 && objString.Substring(i, 7) == "usemtl ")
            {  // material changes
            ...
            else if (beginOfLine && c == 'v' && i < objString.Length - 2 && objString[i + 1] == ' ')
            {  // vertex info follows
                i++;
            ...
            else if (beginOfLine && c == 'v' && i < objString.Length - 2 && objString[i + 1] == 'n' && objString[i + 2] == ' ')
            {  // normal info follows
                i += 2;
                int e = objString.IndexOfEndOfLine(i);
                if (e > i)
            ...
            else if (beginOfLine && c == 'v' && i < objString.Length - 2 && objString[i + 1] == 't' && objString[i + 2] == ' ')
            {  // uv info follows
                i += 2;
                int e = objString.IndexOfEndOfLine(i);
                if (e > i)
            ...
            else if (beginOfLine && c == 'f' && i < objString.Length - 2 && objString[i + 1] == ' ')
            {  // face info follows
                i++;
                int e = objString.IndexOfEndOfLine(i);
                if (e > i)
                    ...
                    for (int r = 0; r < rawIndexes.Count; r++)
                    {
                        ...
                        if (indexes.Length > 0)
                        {
                            ...
                            if (rawVertexIdx >= 0 && rawVertexIdx < rawVs.Count)
                            {
                                ...
                                if (newVIndex >= 0)
                                {  // this vertex was already used in a triangle
                                    Vector3 newV = v;
                                    Vector3 newN = n;
                                    Vector3 newU = u;
    ...
    public static Hashtable[] ImportMaterialSpecs(string mtlString)
    {
        ...
        for (int i = 0; i < mtlString.Length; i++)
        {
            ...
            else if (beginOfLine && c == 'n' && i < mtlString.Length - 7 && mtlString.Substring(i, 7) == "newmtl ")
            {  // material def starts
                i += 7;
            ...
            else if (beginOfLine && c == 'K' && i < mtlString.Length - 3 && mtlString.Substring(i, 3) == "Kd ")
            {  // diffuse color
                i += 2;
                int e = mtlString.IndexOfEndOfLine(i);
                if (e > i)
            ...
            else if (beginOfLine && c == 'K' && i < mtlString.Length - 3 && mtlString.Substring(i, 3) == "Ks ")
            {  // specular color
                i += 2;
                int e = mtlString.IndexOfEndOfLine(i);
                if (e > i)
            ...
            else if (beginOfLine && c == 'd' && i < mtlString.Length - 2 && mtlString[i + 1] == ' ')
            {  // transparency
                i += 2;
                int e = mtlString.IndexOfEndOfLine(i);
                if (e > i)
            ...
            else if (beginOfLine && c == 'T' && i < mtlString.Length - 3 && mtlString.Substring(i, 3) == "Tr ")
            {  // transparency
                i += 3;
                int e = mtlString.IndexOfEndOfLine(i);
                if (e > i)
            ...
            else if (beginOfLine && c == 'N' && i < mtlString.Length - 3 && mtlString.Substring(i, 3) == "Ns ")
            {  // transparency
                i += 3;
                int e = mtlString.IndexOfEndOfLine(i);
                if (e > i)
            ...
            else if (beginOfLine && c == 'm' && i < mtlString.Length - 7 && mtlString.Substring(i, 7) == "map_Kd ")
            {  // transparency
                i += 7;
                int e = mtlString.IndexOfEndOfLine(i);
                if (e > i)
            ...
            else if (beginOfLine && c == 'm' && i < mtlString.Length - 6 && mtlString.Substring(i, 7) == "map_d ")
            {  // transparency
                i += 6;
                int e = mtlString.IndexOfEndOfLine(i);
                if (e > i)
    ...
    private static void PolygonIntoTriangle(int[] polygon, ref List<int> triangles)
    {
        ...
        {  // the polygon is already a triangle
