...
Shader "Numba/Unlit/Lit/ColorDot" {
    Properties {
...
////// Lighting:
                float node_6364 = max(0,dot(i.normalDir,viewDirection));
                float node_2402 = 0.0;
                float3 finalColor = (_Color.rgb*(_BlackThresold + ( (node_6364 - node_2402) * (_WhiteThresolt - _BlackThresold) ) / (1.0 - node_2402)));
